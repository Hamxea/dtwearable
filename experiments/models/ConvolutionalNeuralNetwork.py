...
class ConvolutionalNeuralNetwork():
    ...
    ai_model_class = "ai.aimodels.ConvolutionalNeuralNetwork.ConvolutionalNeuralNetwork"
    ...
    def train(self, dataset_parameters, hyperparameters):
        ...
        #                                                                     X_test, y_test)
        cnn_model = self.train_cnn(X_train, y_train, X_valid, y_valid, hyperparameters['n_steps'])
        # graph = tf.get_default_graph()

        loss, acc = self.test_cnn(cnn_model, X_test, y_test, hyperparameters['n_steps'])

        return cnn_model, {"accuracy": acc, "loss": loss}
    ...
    def train_cnn(self, X_train, y_train, X_valid, y_valid, window_size):
        ...
        model.add(Flatten())
        model.add(Dense(50, kernel_regularizer=l2(0.01), bias_regularizer=l2(0.01), activation='linear'))

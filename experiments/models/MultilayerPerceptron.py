...
from experiments.config import model_plots_path, EPOCHS, data_path
...
class MultilayerPerceptron():
    ...
    ai_model_class = "ai.aimodels.MultilayerPerceptronAIModel.MultilayerPerceptronAIModel"
    ...
    def train(self, dataset_parameters, hyperparameters):
        ...
        mlp_model = self.train_mlp(X_train, y_train, X_valid, y_valid, hyperparameters['n_steps'])
        # graph = tf.get_default_graph()

        acc, loss = self.test_mlp(mlp_model, X_test, y_test, hyperparameters['n_steps'])
    ...
    def train_mlp(self, X_train, y_train, X_valid, y_valid, windowing):
        ...
        n_input_test = X_valid.shape[1] * X_valid.shape[2]
        X_valid = X_valid.reshape(X_valid.shape[0], n_input_test)
    ...
    def test_mlp(self, mlp_model, X_test, y_test, windowing):

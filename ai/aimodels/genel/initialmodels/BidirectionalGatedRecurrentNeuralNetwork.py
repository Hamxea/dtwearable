...
class BidirectionalGatedRecurrentNeuralNetwork(AbstractAIModel):
    ...
    def train(self, dataset_parameters, hyperparameters):
        ...
        bil_gru_model = self.train_bil_gru(X_train, y_train, dataset_parameters['window_size'])
        graph = tf.get_default_graph()

        with graph.as_default():
            score, acc = self.test_bil_gru(bil_gru_model, X_test, y_test, dataset_parameters['window_size'])
    ...
    def train_bil_gru(self, X_train, y_train, window_size):

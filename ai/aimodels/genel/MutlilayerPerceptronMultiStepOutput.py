...
class MutlilayerPerceptronMultiStepOutput(AbstractAIModel):
    ...
    def train(self, dataset_parameters, hyperparameters):
        ...
        train_data, test_data = self.split_dataset(df, dataset_parameters['test_ratio'])
    ...
    def split_dataset(self, data, test_ratio):
        ...
        df_numpy_train = df_numpy[:int(test_ratio*(len(data)))]
        df_numpy_test = df_numpy[int(test_ratio*(len(data))):]

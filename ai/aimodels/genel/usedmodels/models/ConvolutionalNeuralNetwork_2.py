...
class ConvolutionalNeuralNetwork_2(AbstractAIModel):
    ...
    def train(self, dataset_parameters, hyperparameters):
        ...
        cnn_model = self.train_cnn(X_train, y_train, X_test, y_test, dataset_parameters['window_size'])
        graph = tf.get_default_graph()

        with graph.as_default():
            acc, loss = self.test_cnn(cnn_model, X_test, y_test, dataset_parameters['window_size'])
    ...
    def train_cnn(self, X_train, y_train, X_test, y_test, window_size):

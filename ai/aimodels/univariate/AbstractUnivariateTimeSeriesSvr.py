...
class AbstractUnivariateTimeSeriesSvr(AbstractAIModel):
    ...
    def train(self, dataset_parameters, hyperparameters):
        ...
        svr_model, mean_absolute_error_mean, mean_absolute_error_std = self.train_svr(X_train, y_train)

        score = self.test_svr(svr_model, X_test, y_test)

        return svr_model, {"Mean Absolute Error (mean)": mean_absolute_error_mean,

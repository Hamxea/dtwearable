...
class IslemOperasyonResource(Resource):
    ...
    def get(self, islem_operasyon_id: int):
        """ islem_operasyon_id parametresine karsılık Hemsire Gozlem bilgisi donen metod """
    ...
    def delete(self, islem_operasyon_id: int):
        """ islem_operasyon_id parametresine göre Hemsire Gozlem nesnesini donen metod """
